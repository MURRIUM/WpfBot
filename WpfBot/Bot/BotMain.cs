...
namespace WpfBot.Bot
{
    class BotMain
    {
        ...
        {
            Regex mat = new Regex(@"\D*бля*\D|блядь|eбaл|eбaть|xyй|ахуел|ахуеть|бляди|блядина|въеб|въебался|выблядок|выебать|выебон|выебываться|гавно|гавнюк|гандон|гнида|долбоеб|долбоёб|ебало|ебанный|еблан|заебись|лох|лошарa|мразь|мудaк|мудила|не хер|не хуй|наебать|наебет|напиздел|насрать|нахер|нахрен|нахуй|не ебет|нехрен|нехуй|нихуя|отъебись|охуевать|охуел|охуенно|охуеть|охуительно|падла|подонки|подонок|паскуда|пидар|пидарaс|пидарасы|пиздеть|пиздец|пиздит|пиздить|похуй|похую|похер|похрен|похрену|похуй|приебаться|сука|суки|сучка|съебаться|ублюдок|уебать|хер|херня|херовато|хуево|хуевый|хуёвый|хуесос|хуета|хуею|хуи|хуй|чмо|чмошник|шлюха", RegexOptions.IgnoreCase);
